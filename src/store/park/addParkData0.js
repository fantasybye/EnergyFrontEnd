...
const fangAnData = {
    ...
    newBar:[[1467,2376,2076],[12.32,17.43,13.65]],
    fenlei: {
        radar: [[360,650,220], [623,798,559], [557,750,423]],
        newRadar: [[430,763,274], [793, 896,687], [643,932,501]]
    },
    zong: {
...
const newQiYeData = [
    [0.55,0.56, 0.56, 0.57, 0.58, 0.6, 0.65, 0.68, 0.74, 0.77, 0.79, 0.8, 0.78,
        0.77, 0.79, 0.8, 0.81, 0.79, 0.77, 0.72, 0.67, 0.63, 0.6, 0.57, 0.56,0.55],
    [0.09,0.09, 0.09, 0.1, 0.1, 0.12, 0.15, 0.38, 0.54, 0.57, 0.58, 0.59, 0.59,
        0.57, 0.52, 0.45, 0.43, 0.39, 0.37, 0.37, 0.36, 0.3, 0.26, 0.21, 0.09,0.09],
    [0.11,0.12, 0.11, 0.1, 0.1, 0.1, 0.11, 0.13, 0.2, 0.25, 0.3, 0.36, 0.4,
    ...
    yunXingData: {
            ...
            option: {
                ...
                series: [
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[0][0].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#52FFEA'
                    ...
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[0][1].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#FFD984'
                    ...
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[0][2].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#FFFC5A'
            ...
            option: {
                ...
                series: [
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[1][0].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#52FFEA'
                    ...
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[1][1].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#FFD984'
                    ...
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[1][2].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#FFFC5A'
            ...
            option: {
                ...
                series: [
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[2][0].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#52FFEA'
                    ...
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[2][1].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#FFD984'
                    ...
                    {
                        type: 'bar',
                        data: yunXingData.zongJie[2][2].map(item => item*1.2),
                        itemStyle: {        // 系列级个性化折线样式
                            color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                                offset: 0,
                                color: '#FFFC5A'
