...
const parkData2 = {
    name:"高邮风光产业园",
    brief: ["光储充产业园占地约为7700亩，现有企业占地约为3200亩，道路及基础设施占地约为1300亩，规划可用面积约为3200亩，现有符合土地利用规划面积约为1950亩。产业园区的道路情况：甓社路、佛塔路、洞庭湖东路、汤南路、汤北路和园区三路等干道路网络已基本形成，配套美化、绿化、亮化工程，2020年底前将完成洞庭湖路连接工程。园区基础设施完善，供电设施建有220KV的专用变电站2座、110KV的专用变电站；供热设施4座建" +
    "有国信热电厂，主要管网已完成铺设，目前园区内现有企业基本已接入使用；供水设施方面目前500mm环网供水管道已全覆盖园区；建有安源燃气站，主要管网已完成铺设，可满足企业用气需求。供气情况建有国信热电厂，主要管网已完成铺设，目前园区内现有企业基本已接入使用。园区拥有日处理4.5万吨的污水处理厂一座，及专用日处理1500吨的应急污水处理站一座。"],
    miaoShu:[
